...
--
-- Host: localhost
-- Generation Time: Aug 24, 2018 at 08:23 PM
...
--
-- Database: `id6901788_nutrition`
--
DROP DATABASE IF EXISTS `id6901788_nutrition`;
CREATE DATABASE IF NOT EXISTS `id6901788_nutrition` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `id6901788_nutrition`;

DELIMITER $$
--
-- Procedures
--
CREATE DEFINER=`id6901788_healthnet`@`%` PROCEDURE `GetMeals` (IN `userId` INT, IN `mealsDay` DATE)  BEGIN
...
CREATE TABLE `ALIMENT` (
  ...
  `al_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `al_barcode` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `MEAL_TYPE` (
  `mety_id` int(11) NOT NULL,
  `mety_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `UNIT` (
  `un_id` int(11) NOT NULL,
  `un_name` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `USER` (
  ...
  `us_mail` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
